...
// méthode match() :
// extraire les correspondances trouvées dans une chaîne de caractères
...
*/
        ...
        /* Exemple :            const regex = /apple|orange/;
...
// et spécifier les caractères autorisés.
        /* Exemple :        const regex = /^[a-zA-Z0-9_-]{3,20}$/;
