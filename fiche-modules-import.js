...
// Avec "export default", on peut exporter une seule valeur, fonction ou objet par défaut 
// dans un module ==> Permet d'importer cette valeur sans avoir besoin de l'entourer de crochets.
...
// fonctionnalités en fichiers distincts. Chaque module peut exporter des valeurs,
// fonctions ou objets spécifiques, qui peuvent ensuite être importés dans d'autres
// fichiers pour une utilisation.
// Exemple :
// Dans le fichier math.js :
export const add = (a, b) => a + b;
export const subtract = (a, b) => a - b;
...
// On peut également exporter une valeur par défaut. Cela permet d'importer cette valeur 
// sans avoir besoin de l'entourer de crochets.
