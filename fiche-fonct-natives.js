...
// Math.random() en appliquant des opérations mathématiques
...
// parseInt en JavaScript est utilisée pour analyser une chaîne de
...
// split() = Convertir une chaîne en tableau de caractères :
...
87const charArray = str.split("");
console.log(charArray); // Affiche ["H", "e", "l", "l", "o", ",", " ", "W", "o", "r", "l", "d", "!"]

// join() = Convertir un tableau de caractères en chaîne :
